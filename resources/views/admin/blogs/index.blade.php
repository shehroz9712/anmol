            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.blogs.create') !!}" id="sample_editable_1_new" class="btn blue">
                        ...
                        <tbody>
                            @foreach ($records as $key => $record)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{!! $record->slug !!}</td>
                                    @if ($record->media != '' && file_exists(uploadsDir('blogs/') . $record->media))
                                    ...
                                    <td class="center text-center">
                                        <a href="{!! URL::route('admin.blogs.show', $record->id) !!}" class="btn btn-xs blue" title="Show Record">
                                            <i class="fa fa-search"></i>
                                        </a>
                                        <a href="{!! URL::route('admin.blogs.edit', $record->id) !!}" class="btn btn-xs green" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        {{-- @if (in_array($record->id, $restrictedBlogs)) --}}
                                        {{-- <a class="btn btn-xs red" disabled href="javascript:void(this);" data-title="Delete Record" title="Delete Record"> --}}
                                        ...
                                        {{-- @endif --}}
                                        <form action="{!! URL::route('admin.blogs.destroy', $record->id) !!}" method="POST"
