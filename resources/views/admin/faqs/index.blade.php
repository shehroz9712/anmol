...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.faqs.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.faqs.create') !!}" id="sample_editable_1_new"
                               class="btn blue">
                        ...
                        @foreach ($records as $key => $record)
                            <tr class="odd gradeX">
                                ...
                                <td class="center text-center">
                                    ...
                                    <form action="{!! URL::route('admin.faqs.destroy', $record->id) !!}"
...
@section('footer-js')
    ...
    <script src="{!! URL::to('assets/admin/scripts/custom/faqs.js') !!}"></script>
    <script>
