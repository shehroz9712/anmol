        ...
        <!-- BEGIN SAMPLE FORM PORTLET-->
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.faqs.store') }}" class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="answer" class="form-control ckeditor" maxlength="65000">{{ old('answer') }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
