...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.sections.edit', $data) }}
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <form method="POST" action="{{ route('admin.sections.update', $data->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                @if ($data->image != '' && file_exists(uploadsDir('sections/') . $data->media))
