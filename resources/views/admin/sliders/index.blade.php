...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.sliders.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.sliders.create') !!}" id="sample_editable_1_new" class="btn blue">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            @foreach ($records as $key => $record)
                                <tr class="odd gradeX">
                                    <td>{!! $record->name !!}</td>
                                    @if ($record->image != '' && file_exists(uploadsDir('sliders/') . $record->image))
                                        <td><img src="{!! asset('uploads/sliders/' . $record->image) !!}" alt="{!! $record->title !!}"
                                                title="{!! $record->title !!}" style="width: 100px;" /></td>
                                    @else
                                        <td><img src="{!! asset('uploads/sliders/no-image.jpg') !!}"
                                ...
                                nter">
                                        <a href="{!! URL::route('admin.sliders.show', $record->id) !!}" class="btn btn-xs blue" title="Show Record">
                                            <i class="fa fa-search"></i>
                                        </a>
                                        <a href="{!! URL::route('admin.sliders.edit', $record->id) !!}" class="btn btn-xs green" title="Edit Record">
                                        ...
                                        <form action="{!! URL::route('admin.sliders.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <script src="{!! URL::to('assets/admin/scripts/custom/sliders.js') !!}"></script>
    <script>
