...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.sliders.show', $data) }}
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    ...
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><strong>Left Image:</strong> </label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><strong>Right Image:</strong> </label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <button class="btn black" id="cancel"
                                    onclick="window.location.href = '{!! URL::route('admin.sliders.index') !!}'">
                                    < Back..</button>
                            </div>
                        </div>
                    </div>
