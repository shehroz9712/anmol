...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.news_slides.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.news_slides.create') !!}" id="sample_editable_1_new" class="btn blue">
                            ...
                            @foreach ($records as $key => $record)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center text-center">
                                        {{-- <a href="{!! URL::route('admin.news_slides.show', $record->id) !!}" class="btn btn-xs blue" title="Show Record">
                                            <i class="fa fa-search"></i>
                                        </a> --}}
                                        <a href="{!! URL::route('admin.news_slides.edit', $record->id) !!}" class="btn btn-xs green" title="Edit Record">
                                        ...
                                        <form action="{!! URL::route('admin.news_slides.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <script src="{!! URL::to('assets/admin/scripts/custom/news_slides.js') !!}"></script>
    <script>
