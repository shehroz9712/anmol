            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.testimonials.create') !!}" id="sample_editable_1_new" class="btn blue">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                        ...
                        <tbody>
                            @foreach ($records as $key => $record)
                                ...
                                nter">
                                        <a href="{!! URL::route('admin.testimonials.show', $record->id) !!}" class="btn btn-xs blue" title="Show Record">
                                            <i class="fa fa-search"></i>
                                        </a>
                                        <a href="{!! URL::route('admin.testimonials.edit', $record->id) !!}" class="btn btn-xs green" title="Edit Record">
                                        ...
                                        <form action="{!! URL::route('admin.testimonials.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <script src="{!! URL::to('assets/admin/scripts/custom/testimonials.js') !!}"></script>
    <script>
