...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ Breadcrumbs::render('admin.ingredients.index') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-toolbar pull-right">
                        <div class="btn-group">
                            <a href="{!! URL::route('admin.ingredients.create') !!}" id="sample_editable_1_new" class="btn blue">
                            ...
                            @foreach ($records as $key => $record)
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center text-center">
                                        <a href="{!! URL::route('admin.ingredients.show', $record->id) !!}" class="btn btn-xs blue" title="Show Record">
                                            <i class="fa fa-search"></i>
                                        </a>
                                        <a href="{!! URL::route('admin.ingredients.edit', $record->id) !!}" class="btn btn-xs green" title="Edit">
                                        ...
                                        {{-- </a> --}}
                                        <form action="{!! URL::route('admin.ingredients.destroy', $record->id) !!}" method="POST"
...
@section('footer-js')
    ...
    <!-- END PACKAGE LEVEL PLUGINS -->
    <!-- BEGIN PACKAGE LEVEL SCRIPTS -->
